...
{{
  ...
  "city_parsed": "город проведения мероприятия или null",
...
- city_parsed = если в тексте указан только район/округ без города — city_parsed = null
- city_parsed = название города на русском языке (не "Moscow" — "Москва")
